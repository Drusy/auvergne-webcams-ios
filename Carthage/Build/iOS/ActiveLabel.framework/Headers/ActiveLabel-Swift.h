...
- (void)handleMentionTap:(void (^ _Nonnull)(NSString * _Nonnull))handler;
- (void)handleHashtagTap:(void (^ _Nonnull)(NSString * _Nonnull))handler;
- (void)handleURLTap:(void (^ _Nonnull)(NSURL * _Nonnull))handler;
- (void)filterMention:(BOOL (^ _Nonnull)(NSString * _Nonnull))predicate;
- (void)filterHashtag:(BOOL (^ _Nonnull)(NSString * _Nonnull))predicate;
...
- (ActiveLabel * _Nonnull)customize:(SWIFT_NOESCAPE void (^ _Nonnull)(ActiveLabel * _Nonnull))block;
